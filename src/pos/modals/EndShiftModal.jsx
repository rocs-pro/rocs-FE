...
export default function EndShiftModal({ cashierName, onClose, onConfirm }) {
  ...
  const handleConfirm = () => {
      ...
      // Validate Supervisor
      if(!supUser || !supPass) {
          alert("Supervisor approval is required to close the shift.");
          return;
      }

      setLoading(true);
      // Send amount AND supervisor creds
      onConfirm(amount, { username: supUser, password: supPass });
  };
                ...
                <div className="bg-red-50 p-3 rounded border border-red-100">
                    ...
                    <div className="space-y-2">
                        <input 
                            ...
                            className="w-full border border-red-200 rounded px-2 py-1.5 text-xs focus:outline-none focus:border-red-400" 

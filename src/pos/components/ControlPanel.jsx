    ...
    <div className="w-4/12 bg-slate-50 flex flex-col h-full border-r border-slate-200 z-10">
      ...
      <div className="mt-auto p-3 border-t border-slate-300 bg-white shrink-0 shadow-[0_-4px_10px_rgba(0,0,0,0.05)]">
        ...
        <div className="grid grid-cols-2 gap-3">
             ...
             <button className="h-16 bg-slate-700 hover:bg-slate-800 text-white rounded-lg shadow-lg flex flex-col items-center justify-center border-b-[6px] border-slate-900 active:border-b-0 active:mt-1.5 transition-all">
